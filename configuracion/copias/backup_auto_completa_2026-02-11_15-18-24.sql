-- BACKUP AUTOMÁTICO COMPLETA - 2026-02-11_15-18-24
...
DROP TABLE IF EXISTS `catalogo_examenes_gabinete`;
...
DROP TABLE IF EXISTS `depositos_pserv`;
...
DROP TABLE IF EXISTS `diagnosticos_historial`;
...
DROP TABLE IF EXISTS `examenes_gabinete`;
...
DROP TABLE IF EXISTS `examenes_gabinete_det`;
...
DROP TABLE IF EXISTS `examenes_laboratorio_det`;
...
DROP TABLE IF EXISTS `pago_serv`;
...
INSERT INTO `logs` (`id`, `usuario`, `accion`, `fecha`) VALUES (0, 'admin', 'GET /login', '2026-02-11 15:18:16');
INSERT INTO `logs` (`id`, `usuario`, `accion`, `fecha`) VALUES (0, 'admin', 'POST /login', '2026-02-11 15:18:18');
